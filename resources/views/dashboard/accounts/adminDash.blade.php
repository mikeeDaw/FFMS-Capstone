@push('title')
    <title> Admin | Lebria Transport</title>
@endpush
@push('css')
...
<x-dashLayout>
    ...
    <div class="row g-0 bot-margin">
        <div class="d-flex flex-row justify-content-start align-items-center">
            <div class="ms-1 me-5">
                <p class="fs-4 poppins m-0"> Admin Accounts</p>
            </div>
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @foreach ($act_u as $user)
                            ...
                            <tr class="clickRow" data-href={{'/dashboard/admins/'.$user[0]}}>
    ...
    <div class="col-lg-7 col-9 formWrapper" data-form-add>
        <div class="mb-4 position-relative">
            <div>
            <span class="d-block text-start fs-5 fw-medium poppins "> Create Admin Account </span>
        ...
        <form action="/dashboard/admins/create" method="post">
            @csrf
            {{-- Form Fields --}}
            <x-userForm />
